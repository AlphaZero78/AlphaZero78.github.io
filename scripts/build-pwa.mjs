...
// This distinct navigation path bypasses legacy workers that cache index.html
// while discarding query strings. The page removes only this site's local cache.
await writeFile(resolve(root,'preview.html'), await readFile(resolve(root,'index.html')));
