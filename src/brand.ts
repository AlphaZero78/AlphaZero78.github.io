...
export const logo = `<svg viewBox="0 0 310 185" aria-label="AlphaZero personal archive" role="img">${paths}<text x="165" y="174" text-anchor="middle" font-family="MiSans,sans-serif" font-size="16" font-weight="700" letter-spacing="22">ALPHAZERO</text></svg>`;
...
export const brandHeading = `<h1>ALPHAZERO</h1><div>ZIHAN DONG / USTC</div><p><span class="brand-personal">PERSONAL</span><b>OS</b></p>`;
